...
/***************************************************************************************************************************
Object: dbo.MAMAppProtectionStatus
...
IF OBJECT_ID(N'dbo.MAMAppProtectionStatus') IS NOT NULL
BEGIN
    DROP TABLE dbo.MAMAppProtectionStatus;
    PRINT 'Table "MAMAppProtectionStatus" Dropped.';
END;
GO

-- Create Table:
CREATE TABLE dbo.MAMAppProtectionStatus ( [User] nvarchar(256) NULL
                                         ...
                                         ,ManagementType nvarchar(25) NULL
                                         ,AppProtectionStatus nvarchar(25) NULL
...
IF OBJECT_ID(N'dbo.MAMAppProtectionStatus') IS NOT NULL
PRINT 'Table "MAMAppProtectionStatus" Created';
GO