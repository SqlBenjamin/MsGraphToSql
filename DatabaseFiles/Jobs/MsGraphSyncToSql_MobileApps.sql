...
IF EXISTS (SELECT job_id FROM msdb.dbo.sysjobs_view WHERE name = N'MsGraphSyncToSql_MobileApps')
BEGIN
    EXECUTE msdb.dbo.sp_delete_job @job_name = N'MsGraphSyncToSql_MobileApps', @delete_unused_schedule = 1;
    PRINT 'Job "MsGraphSyncToSql_MobileApps" Deleted.';
END;
GO

/********************************************************************************************
Object: dbo.MsGraphSyncToSql_MobileApps
...
----------------------------------------------------------------------------------------------
DECLARE  @JobName sysname = N'MsGraphSyncToSql_MobileApps';
