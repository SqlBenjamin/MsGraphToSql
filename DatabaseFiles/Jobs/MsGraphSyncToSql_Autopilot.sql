...
IF EXISTS (SELECT job_id FROM msdb.dbo.sysjobs_view WHERE name = N'MsGraphSyncToSql_Autopilot')
BEGIN
    EXECUTE msdb.dbo.sp_delete_job @job_name = N'MsGraphSyncToSql_Autopilot', @delete_unused_schedule = 1;
    PRINT 'Job "MsGraphSyncToSql_Autopilot" Deleted.';
END;
GO

/********************************************************************************************
Object: dbo.MsGraphSyncToSql_Autopilot
...
----------------------------------------------------------------------------------------------
DECLARE  @JobName sysname = N'MsGraphSyncToSql_Autopilot';
