...
IF EXISTS (SELECT job_id FROM msdb.dbo.sysjobs_view WHERE name = N'MsGraphSyncToSql_Devices')
BEGIN
    EXECUTE msdb.dbo.sp_delete_job @job_name = N'MsGraphSyncToSql_Devices', @delete_unused_schedule = 1;
    PRINT 'Job "MsGraphSyncToSql_Devices" Deleted.';
END;
GO

/********************************************************************************************
Object: dbo.MsGraphSyncToSql_Devices
...
----------------------------------------------------------------------------------------------
DECLARE  @JobName sysname = N'MsGraphSyncToSql_Devices';
...
EXECUTE @ReturnCode = msdb.dbo.sp_add_jobschedule
       ...
       ,@active_start_time = 60000 -- 6AM (HHMMSS)
...
EXECUTE @ReturnCode = msdb.dbo.sp_add_jobschedule
       ...
       ,@active_start_date = 20081026
       ,@active_end_date = 99991231
       ,@active_start_time = 180000 -- 6PM (HHMMSS)
       ,@active_end_time = 235959;
IF (@@ERROR != 0 OR @ReturnCode != 0)
GOTO QuitWithRollback;
