...
/***************************************************************************************************************************
Object: dbo.v_LatestTableRefreshUriInfo
...
IF OBJECT_ID(N'dbo.v_LatestTableRefreshUriInfo') IS NOT NULL
BEGIN
    DROP VIEW dbo.v_LatestTableRefreshUriInfo;
    PRINT 'View "v_LatestTableRefreshUriInfo" Dropped.';
END;
GO

-- View Definition:
CREATE VIEW dbo.v_LatestTableRefreshUriInfo AS
WITH LatestTable AS (
SELECT  TableName
       ,MAX(ID) AS [MaxID]
...
IF OBJECT_ID(N'dbo.v_LatestTableRefreshUriInfo') IS NOT NULL
PRINT 'View "v_LatestTableRefreshUriInfo" Created';
GO