...
/***************************************************************************************************************************
Object: dbo.v_LatestBatchTableRefreshInfo
...
IF OBJECT_ID(N'dbo.v_LatestBatchTableRefreshInfo') IS NOT NULL
BEGIN
    DROP VIEW dbo.v_LatestBatchTableRefreshInfo;
    PRINT 'View "v_LatestBatchTableRefreshInfo" Dropped.';
END;
GO

-- View Definition:
CREATE VIEW dbo.v_LatestBatchTableRefreshInfo AS
SELECT  his.ID
       ,his.BatchID
       ,his.TableName
       ,his.StartDateUTC
...
IF OBJECT_ID(N'dbo.v_LatestBatchTableRefreshInfo') IS NOT NULL
PRINT 'View "v_LatestBatchTableRefreshInfo" Created';
GO