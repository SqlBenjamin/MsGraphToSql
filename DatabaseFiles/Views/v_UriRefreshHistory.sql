...
/***************************************************************************************************************************
Object: dbo.v_UriRefreshHistory
...
IF OBJECT_ID(N'dbo.v_UriRefreshHistory') IS NOT NULL
BEGIN
    DROP VIEW dbo.v_UriRefreshHistory;
    PRINT 'View "v_UriRefreshHistory" Dropped.';
END;
GO

-- View Definition:
CREATE VIEW dbo.v_UriRefreshHistory AS
SELECT  his.ID
       ,his.BatchID
       ,his.TableName
...
IF OBJECT_ID(N'dbo.v_UriRefreshHistory') IS NOT NULL
PRINT 'View "v_UriRefreshHistory" Created';
GO